...
double Utilities::distKM(const double& x0,const double& y0, const double& x1,const double& y1)
{
    double R = 6371; //KM
    double phi1 = x0*3.14/180;
    double phi2 = x1*3.14/180;
...
double Utilities::distKM(const QPointF& a, const QPointF& b)
{
   return distKM(a.x(),a.y(),b.x(),b.y());
}
